...
function hungryDog(weight, age){
  if(age >= 1) {
    if(weight <= 5) {
      let food = (weight / 100) * 5;
      return Number(food.toFixed(2));
    } else if(weight > 5 && weight < 11) {
      let food = (weight / 100) * 4;
      return Number(food.toFixed(2));
    } else if(weight > 10 && weight < 16) {
      let food = (weight / 100) * 3;
      return Number(food.toFixed(2));
    } else if(weight > 15) {
      let food = (weight /100) * 2;
      return Number(food.toFixed(2));
    }
  } else {
    if(age > 0.15 && age < 0.34) {
      let food = (weight / 100) * 10;
      return Number(food.toFixed(2));
    } else if(age > 0.33 && age < 0.59) {
      let food = (weight / 100) * 5;
      return Number(food.toFixed(2));
...
function game(user, computer){
  if (user === computer) {
    return "it's a tie";
  } else if(user === 'rock' && computer !== 'paper' && user !== computer) {
    return 'you win!';
  } else if(user === 'paper' && computer !== 'scissors' && user !== computer) {
    return 'you win!'
  }else if(user === 'scissors' && computer !== 'rock' && user !== computer) {
    return 'you win!'
